...
void nautilus_module_initialize(GTypeModule *module) {
  ...
  type_id = g_type_module_register_type(
      module, G_TYPE_OBJECT, "CreateFileExtension",
      &*create_file_extension_get_info(), (GTypeFlags)0);

  static const GInterfaceInfo menu_info = {
      (GInterfaceInitFunc)menu_provider_iface_init, NULL, NULL};
  g_type_module_add_interface(module, type_id, NAUTILUS_TYPE_MENU_PROVIDER,
                              &menu_info);
...
void nautilus_module_shutdown(void) { g_print("libnautilus_ext: shutdown\n"); }
}
